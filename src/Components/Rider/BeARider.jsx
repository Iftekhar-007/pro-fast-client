...
const BeARider = () => {
  ...
  const availableDistricts = warehouses
  ...
  const onSubmit = async (data) => {
    const riderData = {
      ...
      email: user?.email || "not_provided@example.com",
    };
    ...
    <div className="max-w-2xl mx-auto p-4 bg-white shadow-lg rounded-xl">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <input
          ...
          {...register("NID Number", { required: true })}
          className="input input-bordered w-full"
        />
        {errors.NID_Number && <p className="text-red-500">NID Number</p>}
        ...
        />
        {errors.bikeName && (
          <p className="text-red-500">Bike name is required</p>
        )}
        ...
        />
        {errors.bikeLicense && (
          <p className="text-red-500">License is required</p>
        )}
